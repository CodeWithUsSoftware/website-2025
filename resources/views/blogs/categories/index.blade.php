                    ...
                    <section class="py-10 md:py-20">
                        <div class=" pb-3 md:pb-0 border shadow rounded-xl">
                            <div>
                                ...
                                <div
                                    class="pt-5 md:pt-2 mb-8 text-sm text-black-lighter-3 text-center md:text-left hover:text-primary cursor-pointer m-4">
                        ...
                        <div class="rounded-xl shadow p-3 px-10 border  border-2 mt-8">
                            <!--          Book A FREE Trial-->
                            <div class="space-y-5">
