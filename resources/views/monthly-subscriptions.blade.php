            ...
            <div class="max-w-6xl mx-auto px-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 flex items-center justify-center">
                    <div class="md:order-2"> <img loading="lazy" class="rounded" src="/images/trial_form/flying.png"
                            alt=""></div>
                    <div>
                        {!! trans('monthaly_subs.100%_personalized') !!}
                        <ul class="text-black-lighter-3">
                            <li class="flex items-center space-x-2">
                                ...
                                <div>{!! trans('monthaly_subs.classes_on_your_schedule') !!}</div>
                            </li>
                            <li class="flex items-center space-x-2 space-y-3">
                                ...
                                <div>{!! trans('monthaly_subs.15+_topics') !!}</div>
                            </li>
                            <li class="flex items-center space-x-2 space-y-3">
                                ...
                                <div>{!! trans('monthaly_subs.private_semi_private') !!}</div>
                            </li>
                            <li class="flex items-center space-x-2 space-y-3">
                                ...
                                <div>{{ trans('monthaly_subs.caring_knowledgeable_instructors') }}</div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="max-w-6xl mx-auto px-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 flex items-center justify-center">
                    <div> <img loading="lazy" class="rounded object-cover" src="/images/trial_form/student_1.png"
                            alt=""></div>
                    <div>
                        <h5>{{ trans('monthaly_subs.personalized_coding_education') }}</h5>
                        {!! trans('monthaly_subs.personalized_coding_education_description') !!}
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-6xl mx-auto px-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 flex items-center justify-center">
                    <div class="md:order-2"> <img loading="lazy" class="rounded" src="/images/trial_form/student_2.png"
                            alt=""></div>
                    <div>
                        <h5>{{ trans('monthaly_subs.weekly_recurring_lasses') }}</h5>
                        {!! trans('monthaly_subs.weekly_recurring_lasses_description') !!}
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-10 md:py-20">
            <div class="max-w-6xl mx-auto px-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 flex items-center justify-center">
                    ...
                    <div>
                        <h5>{{ trans('monthaly_subs.one_more_thing') }}</h5>
                        {!! trans('monthaly_subs.one_more_thing_description') !!}
                    </div>
                </div>
            </div>
        </section>
            ...
            <div
                ...
                <div class="md:p-0">
                    <div
                        ...
                        <button type="button"
                            class="inline-flex items-center p-6 border border-transparent   rounded-full shadow-primary text-white bg-info hover:bg-info-lighter-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-info">
                ...
                <div class="md:text-left">
                    <p class="text-sm">
                        {{ trans('monthaly_subs.did_you_know_description') }}
                    </p>
                </div>
            </div>
        </section>
