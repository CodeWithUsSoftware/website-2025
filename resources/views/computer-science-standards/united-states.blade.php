...
@section('title')
    {{ $data['united_state_page_data']['title'] }} | CodeWithUs | Code With Us
@endsection
@section('content')
        ...
        <div class="relative max-w-full mx-auto ">
            <div class="relative py-10 px-8 overflow-hidden lg:px-16 takeover-panel-topic">
                <div class="absolute inset-0">
                    ...
                    <img src="/images/computer_standerd/ban1.png" alt="Banner" class="h-96 w-full md:w-full object-cover">
                ...
                <div class="relative text-center">
                    <div class="max-w-3xl mx-auto">
                        <h2 class="display-3 font-weight-bolder text-white computer-heading">
                            {{ $data['united_state_page_data']['title'] }} gsdgsdgsd </h2>
                    </div>
                    <div class="max-w-4xl mx-auto mb-5">
                        <h6 class="text-white">{{ $data['united_state_page_data']['description'] }} </h6>
                    </div>
                    <button type="submit"
                ...
                border border-primary rounded-full text-white bg-primary hover:bg-primary-darker-1 focus:outline-none"
                        style="width: 19rem;
                padding: 10px;">
                        <span> <a href="/school-program#trial_form" class="hover:text-white">Schedule a Free Trial class for
                                your school</a></span>
                    </button>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-2">
                        <a href="/computer-science-standards/united-states"
                            class="font-bold hover:text-primary-darker-5  focus:outline-none text-primary">United States</a>
                    </div>
    ...
    <div class="max-w-5xl bg-white py-10 rounded-2xl mx-auto shadow-card mb-10">
        <section>
            <div class="p-5 space-y-3">
                {!! $data['united_state_page_data']['long_description'] !!}
            </div>
        </section>
    </div>
