            ...
            <transition :name="slide_animation">
                ...
                >
                    <div class="space-y-8 pb-20">
                        <div class="pt-2">
                            <div
                                class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6"
                            >
                                <div class="">
                                    <label
                            ...
                            >
                                ...
                                <div
                                    class="space-y-1 max-h-96 overflow-y-auto p-0 md:px-10"
                                >
                                    <div
                    ...
                    >Teacher</button>
                                    ...
                                    >
                                        ...
                                        <button
                                            type="button"
                                            class="col-span-2 p-1 md:p-3 md:mx-2 rounded-xl"
                                            :class="
                                                registration.slot.slot ===
                                                    slot.slot &&
                                                registration.slot.teacher.id ===
            ...
            <transition :name="slide_animation">
                <section class="text-center py-10" v-if="step === 5">
                    ...
                    <div class="pt-10 space-y-2">
                        ...
                        <p>
                            <span class="font-bold"
                                ><span class="text-primary">Amount:</span></span
                            >
                            ${{
                                registration.class_type !== "group"
                                    ? private_session_fee
