<template>
    <div class="min-h-screen bg-gray-50">
        <div
            id="monthly-subscription-mobile"
                    ...
                    <div :key="step" class="p-4 h-full flex flex-col">
                        ...
                        <section v-if="step === 1" class="flex-1 flex flex-col">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-xs text-gray-600">
                                    Choose
                                    {{ registration.class_per_week }} weekly
                                    time slot(s)
                                </p>
                                <p
                            ...
                            <div class="flex-1 space-y-4">
                                ...
                                <div
                                    v-if="
                                        registration.selectedTaskClasses
                                            .length > 0
                                    "
                                >
                                    <h4
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="w-full m-1 cursor-pointer space-y-2 md:space-y-0 md:space-x-2 inline-flex items-center justify-center px-2 py-2 text-sm border border-blue-500 rounded-full text-white bg-blue-500 hover:bg-blue-600 focus:outline-none"
                                                >
                                                    <span
                                                        >{{
                                                            filters.date_format(
                            ...
                            <div class="flex-1 space-y-4">
                                ...
                                >
                                    <div>
                                        ...
                                        />
                                        <small
                                            v-if="studentNameError"
                                            class="text-red-500 block mt-1"
                                            >Please enter student's name</small
                                        >
                                    </div>
                        ...
                        <section v-if="step === 3" class="flex-1 flex flex-col">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-xs text-gray-600">
                                    Review your details before proceeding to
                                    payment
                                </p>
                            </div>
                        ...
                        <section
                            v-show="step === 4"
                            class="payment-section flex-1 flex flex-col"
                        >
...
export default {
    ...
    computed: {
        ...
        classPerWeekText() {
            return this.registration.class_per_week > 1
                ? "Twice a Week"
                : "Once a Week";
        },
        net_price() {
        ...
        selectedPlanLabel() {
            return (
                this.selectedPlan.charAt(0).toUpperCase() +
                this.selectedPlan.slice(1)
            );
        },
        ...
        formattedPhoneNumber() {
            if (!this.phoneObject || !this.registration.parent?.phone_number)
                return "";
        ...
        isSlotSelected() {
            return (slot) => {
                return this.registration.selectedTaskClasses.some(
                    (s) =>
    ...
    created() {
        this.private_class_price_per_class = parseInt(
            this.private_classes_discount_price
        );
        this.group_class_price_per_class = parseInt(
            this.group_classes_discount_price
        );
    ...
    methods: {
        ...
        dateClicked(e) {
            const currentSelectedDate =
                this.registration.selected_date_raw || new Date().format();
            ...
            if (!moment(enteredDate).isBetween(today, endDatePlusOne)) {
                this.notify.setMessage(
                    `Select date between ${this.filters.date_format(
                        startDate
                    )} and ${this.filters.date_format(endDate)}`
                );
                setTimeout(() => {
            ...
            if (!this.loader) {
                ...
                this.notify.setMessage(
                    "Please wait while we load available slots..."
                );
                setTimeout(() => {
                    this.registration.selected_date_raw = currentSelectedDate;
                }, 300);
        ...
        async submitStepTwo() {
            ...
            if (!this.registration.parent.full_name) {
                this.registration.parent.full_name =
                    this.registration.student.full_name;
            }
        ...
        handleTopicSelection() {
            const topic = this.topics.topics.find(
                (t) => t.id === this.registration.topic_id
            );
        ...
        handleLocationSelection() {
            const location = this.locations.locations.find(
                (l) => l.id === this.registration.location_id
            );
        ...
        deleteSlot(slot) {
            this.registration.selectedTaskClasses =
                this.registration.selectedTaskClasses.filter(
                    (s) =>
                        !(
                            s.slot === slot.slot &&
                            s.teacher.id === slot.teacher.id
                        )
                );
        },
    },
