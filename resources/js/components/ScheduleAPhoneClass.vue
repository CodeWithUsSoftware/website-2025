<template>
    <div class="px-3 md:px-0">
        <div
            id="phone-call"
            class="md:max-w-6xl mx-auto bg-white rounded-3xl shadow-card p-10 space-y-10 overflow-x-hidden"
            :class="step === 1 ? 'pb-52' : ''"
        >
            ...
            <transition :name="slide_animation">
                <form v-if="step === 1" @submit.prevent="next">
                    ...
                    <small v-if="error.errors.reason" class="text-red-500">{{
                        error.errors.reason
                    }}</small>
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 md:gap-2">
                        ...
                        >
                            ...
                            >
                                ...
                                ({{ filters.format_time_zone(user_time_zone) }})
                            </div>
                            <div v-else>
                            ...
                            <div
                                ...
                                v-for="(slot, index) in available_time_slots"
                                :key="index"
                            >
                                <div
                                    v-if="
                                        phone_call.selected_date && !slot.booked
                                    "
                                    @click="selectClassHandler(slot)"
                                >
                                    <button
                                        type="button"
                                        class="p-3 md:mx-2 rounded-xl capitalize"
                                        :class="
                                            phone_call.slot.slot === slot.slot
                            ...
                            <p
                                ...
                                class="capitalize text-center text-red-500"
                            >
                                {{ slots_not_available }}
                            </p>
                        </div>
                    ...
                    <div class="pt-10">
                        <div class="flex justify-center">
                            <button
                                ...
                                "
                                class="disabled:opacity-50 disabled:cursor-not-allowed shadow-primary w-full md:w-max mx-auto px-20 py-2 text-sm font-medium border border-primary rounded-full text-white bg-primary hover:bg-primary-darker-1 focus:outline-none"
                            >
                                Next
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="text-center space-y-3 md:space-y-0">
                            ...
                            <button
                                @click="back"
                                type="button"
                                class="disabled:opacity-50 disabled:cursor-not-allowed shadow-primary w-full md:w-max px-20 py-2 text-sm font-medium border border-primary rounded-full text-primary bg-white hover:bg-primary-darker-1 focus:text-white focus:outline-none"
                            >
                                Cancel
                            </button>
                        </div>
            ...
            <transition :name="slide_animation">
                <section class="py-12" v-if="step === 4">
                    ...
                    <p class="text-center">
                        You successfully booked a phone call, as per details
                        below:
                    </p>
                    <div class="md:pl-60 pt-10 space-y-2">
                        <p>
                            ...
                            >
                            {{
                                filters.day_date(phone_call.selected_date_raw)
                            }}
                            {{ phone_call.slot.slot_display }} ({{
                                filters.format_time_zone(user_time_zone)
                            }})
