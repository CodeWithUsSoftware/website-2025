<template>
        ...
        <div v-if="step === 0">
            <section class="pt-5">
                <div class="max-w-3xl mx-auto">
                    <div
                        class="mb-2 flex flex-col md:flex-row justify-start border-b px-5"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                Camps are loading, please wait...
                                <svg
                                    class="animate-spin w-10 h-10 text-black"
                                    fill="currentColor"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                            ...
                            <div class="max-w-3xl mx-auto">
                                <div class="flex justify-center">
                                    <div
                                        class="relative bg-gray-200 rounded-full p-1 flex"
                                    >
                                        <button
                                            disabled
                                            class="relative px-6 py-3 text-lg font-medium rounded-full whitespace-nowrap z-10 text-white"
                                        >
                                            Campbell, CA
                                        </button>
                                        <button
                                            disabled
                                            class="relative px-6 py-3 text-lg font-medium rounded-full whitespace-nowrap z-10 text-gray-600"
                                        >
                                            Online Classroom
                                        </button>
                                        <button
                                        ...
                                        <div
                                            class="absolute top-1 bottom-1 bg-teal-600 rounded-full z-0"
                                            style="
                                                left: 4px;
                    ...
                    <p class="text-center py-2" v-if="locationsStore.location">
                        {{ locationsStore.location.address }}
                    </p>
                </div>
            </section>
            ...
            >
                <div class="max-w-5xl mx-auto bg-white md:p-5 space-y-5">
                    <div class="py-3 row" v-if="campStore.groups_count > 0">
                        <div
                            class="accordion-item border border-gray-200 rounded-lg mb-4"
                        ...
                        >
                            <div class="accordion-header">
                                <button
                                    ...
                                    :class="{
                                        'rounded-lg': !accordionOpen[index],
                                    }"
                                >
                                    <h5
                                    ...
                                    <svg
                                        ...
                                        :class="{
                                            'rotate-180': accordionOpen[index],
                                        }"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                    ...
                    <div
                        v-if="!campStore.groups_count"
                        class="m-5 space-y-10 flex justify-center"
                    >
                        Camps not available
                    </div>
                </div>
        ...
        <div class="max-w-5xl mx-auto" v-show="step > 0">
            <div>
                <div class="px-3 md:px-0">
                    <div
                        class="space-y-8 shadow-card rounded-3xl p-10 md:px-10 overflow-x-hidden"
                    >
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="hidden sm:flex flex-col justify-center items-center"
                            >
                                <nav class="flex" aria-label="Breadcrumb">
                                    ...
                                    >
                                        ...
                                        >
                                            <a
                                                href="#"
                                                class="ml-1 text-sm text-gray-500 hover:text-gray-700"
                                                >Topics Options</a
                                            >
                                        </li>
                                        <li
                                        ...
                                        >
                                            <div class="flex items-center">
                                                ...
                                                <a
                                                    ...
                                                    "
                                                    class="ml-4 text-sm text-gray-500 hover:text-primary-darker-1"
                                                    >Session Options</a
                                                >
                                            </div>
                                        </li>
                                                ...
                                                <a
                                                    ...
                                                    :class="
                                                        step === 4
                                                            ...
                                                            : 'text-gray-500 hover:text-gray-700'
                                                    "
                                                    class="ml-4 text-sm text-primary hover:text-primary-darker-1"
                                                    >Payment</a
                                                >
                                            </div>
                                        </li>
                            ...
                            <div
                                v-if="step < 5"
                                class="sm:hidden bg-white rounded-md shadow px-4 py-3 mt-3 mx-auto"
                            >
                                <div
                        ...
                        <section class="py-5 md:py-10">
                            <div
                                v-if="currentRegistration.location"
                                ref="campSummary"
                            >
                                <h3 class="text-center pt-8 pb-0">
                                    Schedule a Camp
                                </h3>
                                <p class="text-center">
                                        ...
                                        <div class="mt-6 grid grid-cols-1">
                                            ...
                                            >
                                                <input
                                                    type="checkbox"
                                                    v-model="
                                                        currentRegistration.optional_date
                                                    "
                            ...
                            >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <input
                                                                    ...
                                                                    "
                                                                    :checked="
                                                                        currentRegistration.students &&
                                                                        currentRegistration.students.includes(
                                                                            student
                                                                        )
                                                                    "
                                                                    @change="
                                ...
                                <div class="mt-1">
                                    ...
                                    class="shadow-sm focus:ring-primary focus:border-primary block w-full sm:text-sm border-gray-100 bg-gray-100 rounded-full">
                                            ...
                                            <div
                                                class="mt-6 grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-6"
                            ...
                            <section class="py-5 md:py-10" v-if="step === 3">
                                <div class="space-y-20">
                                    <h5 class="text-center font-bold">
                                        Are you sure you want to book a camp?
                                    </h5>
                                    ...
                                    <div
                                        ...
                                        :key="index"
                                        class="md:px-32 space-y-2 mb-8 pb-8 border-b"
                                    >
                                        <h6 class="font-bold">
                                        ...
                                        <div
                                            class="space-y-2 p-4 border rounded-md bg-gray-100"
                                        >
                                            <p>
                                                <span
                                                ...
                                                <span class="capitalize"
                                                    >${{
                                                        student.original_amount.toFixed(
                                                            2
                                                        )
                                                    }}</span
                                                >
                            ...
                            <p><span class="font-bold text-primary">Camp Timing:&nbsp;</span>
                                <span class="capitalize"> </span>
                                    ...
                                    <div class="md:px-32 space-y-2 mb-8 pb-8">
                                        ...
                                        <div
                                            class="space-y-2 p-4 border rounded-md bg-gray-100 flex items-center justify-between"
                                        >
                                            <h6 class="font-bold text-primary">
                                                Total:
                                            </h6>
                                            <h6
                                                class="text-primary p-1 px-4 font-bold bg-blue-100 rounded flex items-center gap-1"
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        fill="#18CEF6"
                                                        d="M26.029 58.156c-1.683 0-3.047 1.334-3.047 2.979 0 1.646 1.364 2.979 3.047 2.979s3.047-1.333 3.047-2.979c0-1.645-1.364-2.979-3.047-2.979zm17.795 0c-1.682 0-3.046 1.334-3.046 2.979 0 1.646 1.364 2.979 3.046 2.979 1.683 0 3.047-1.333 3.047-2.979 0-1.645-1.364-2.979-3.047-2.979z"
                                                    />
                                                </svg>
                                    ...
                                    >
                                        <button
                                            type="button"
                                            @click="back()"
                                            class="btn w-full md:w-max text-primary justify-center"
                                        >
                                            Back
                                        </button>
                                        <button
                                            type="button"
                                            class="btn bg-primary text-white justify-center"
                                            @click="addMore()"
                                        >
                                            Add Another Camp
                                        </button>
                                        <button
                                            ...
                                            class="btn w-full md:w-max bg-primary text-white justify-center"
                            ...
                            <section class="py-5 md:py-10" v-show="step === 4">
                                ...
                                >
                                    <div
                                        class="mx-auto justify-center space-y-16 divide-y"
                                        :class="
                                            step === 4
                                                ? 'max-w-5xl'
                                                : 'max-w-2xl'
                            ...
                            <section class="py-5 md:py-10" v-if="step === 5">
                                <div class="space-y-10">
                                    <h5
                                        class="text-success text-center font-bold"
                                    >
                                        Thank you!
                                    </h5>
    ...
    <transition name="fade">
        ...
        >
            <div
                class="bg-white p-4 rounded-lg shadow-lg max-w-5xl w-full h-[450px] overflow-y-auto px-20"
                @click.stop
            >
                <div>
                    <div class="flex items-center justify-end">
                        <button @click="isModalOpen = false">
                            <svg
                                class="w-5 h-5 text-primary hover:text-danger"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16"
                                fill="currentColor"
                            >
                    ...
                    <div>
                        <div class="bg-white">
                            <div class="mx-auto max-w-5xl">
                                <h1
                                    class="text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-2xl"
                                >
                                    Camps Cart
                                </h1>
                                ...
                                <form class="mt-2">
                                    <section aria-labelledby="cart-heading">
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="ml-4 flex flex-1 flex-col sm:ml-6"
                                                >
                                                    <div>
                                                        <div
                                    ...
                                    >
                                        ...
                                        <div class="mt-10">
                                            <button
                                                type="button"
                                                class="btn bg-primary text-white w-full justify-center"
...
export default {
    ...
    methods: {
            ...
            if (this.currentRegistration.phone?.nationalNumber) {
                this.studentStore
                    ...
                    .then((response) => {
                        ...
                        this.currentRegistration.parent = this.studentStore
                            .parent || {
                            id: "",
                            full_name: "",
                            age: "",
        ...
        addMore() {
            ...
            if (this.step == 0) {
                this.$nextTick(() => {
                    this.$refs.campsData?.scrollIntoView({
                        behavior: "smooth",
                        block: "start",
                    });
                });
